package com.leofight.aspect;

import com.leofight.introduction.LittleUniverse;
...
public class ServiceAspect {
	...
	@Pointcut("execution(* com.leofight.service..*.*(..))")
	public void embed(){}
	@Before("embed()")
	...
	@DeclareParents(value = "com.leofight.controller..*", defaultImpl = com.leofight.introduction.impl.LittleUniverseImpl.class)
